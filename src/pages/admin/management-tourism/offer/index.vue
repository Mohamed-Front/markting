...
const fetchData = () => {
  ...
  axios.get("/api/Offers/all/Offers").then((res) => {
    loading.value = false
...
const deleteAction = () => {
  axios
    .get(`/api/Offers/delete/${user.value.id}`)
    .then((res) => {
      console.log(res.data)
    ...
    <div class="col-12">
      <va-card class="card">
        ...
        >
          ...
          <Column field="old price" header="old price" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data?.old_price }} PE
            </template>
          </Column>
          <Column field="new price" header="new price" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              {{ slotProps.data?.new_price }} PE
            </template>
          </Column>
          ...
          <Column field="Images" header="Images" :sortable="true" header-style="width:14%; min-width:10rem;">
            <template #body="slotProps">
              <img :src="`http://marketing.mqawilk.com/public/images/Offers/${slotProps.data?.id}/` + slotProps.data?.image" >
            </template>
          </Column>
